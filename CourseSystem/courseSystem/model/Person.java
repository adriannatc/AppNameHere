...
abstract class Person implements Outputable {
	 ...
	 */
	public void readData (int pID, String pFirstName, String pMInitial, String pLastName, String pEmail) {
		try {
			this.idNum = pID;
			this.lastName = pLastName;
			this.initial = pMInitial;
	...
	public void edit(Person person){
		...
		changeInitial(person.getInitial());
